...
public static class LeanTweenExt
{
    ...
    //LeanTween.alpha
    public static LTDescr LeanAlpha(this UnityEngine.GameObject gameObject, float to, float time) { return LeanTween.alpha(gameObject, to, time); }
    //LeanTween.alphaCanvas
    public static LTDescr LeanAlphaVertex(this UnityEngine.GameObject gameObject, float to, float time) { return LeanTween.alphaVertex(gameObject, to, time); }
    ...
    //LeanTween.cancel
    public static void LeanCancel(this UnityEngine.GameObject gameObject) { LeanTween.cancel(gameObject); }
    public static void LeanCancel(this UnityEngine.GameObject gameObject, bool callOnComplete) { LeanTween.cancel(gameObject, callOnComplete); }
    public static void LeanCancel(this UnityEngine.GameObject gameObject, int uniqueId, bool callOnComplete = false) { LeanTween.cancel(gameObject, uniqueId, callOnComplete); }
    //LeanTween.cancel
    public static void LeanCancel(this RectTransform rectTransform) { LeanTween.cancel(rectTransform); }
    //LeanTween.cancelAll
    //LeanTween.color
    public static LTDescr LeanColor(this UnityEngine.GameObject gameObject, Color to, float time) { return LeanTween.color(gameObject, to, time); }
    //LeanTween.colorText
    ...
    public static LTDescr LeanDelayedCall(this UnityEngine.GameObject gameObject, float delayTime, System.Action callback) { return LeanTween.delayedCall(gameObject, delayTime, callback); }
    public static LTDescr LeanDelayedCall(this UnityEngine.GameObject gameObject, float delayTime, System.Action<object> callback) { return LeanTween.delayedCall(gameObject, delayTime, callback); }

    //LeanTween.isPaused
    public static bool LeanIsPaused(this UnityEngine.GameObject gameObject) { return LeanTween.isPaused(gameObject); }
    ...
    public static bool LeanIsTweening(this UnityEngine.GameObject gameObject) { return LeanTween.isTweening(gameObject); }
    //LeanTween.isTweening
    //LeanTween.move
    public static LTDescr LeanMove(this UnityEngine.GameObject gameObject, Vector3 to, float time) { return LeanTween.move(gameObject, to, time); }
    ...
    //LeanTween.move
    public static LTDescr LeanMove(this UnityEngine.GameObject gameObject, Vector2 to, float time) { return LeanTween.move(gameObject, to, time); }
    ...
    //LeanTween.move
    public static LTDescr LeanMove(this UnityEngine.GameObject gameObject, Vector3[] to, float time) { return LeanTween.move(gameObject, to, time); }
    public static LTDescr LeanMove(this UnityEngine.GameObject gameObject, LTBezierPath to, float time) { return LeanTween.move(gameObject, to, time); }
    public static LTDescr LeanMove(this UnityEngine.GameObject gameObject, LTSpline to, float time) { return LeanTween.move(gameObject, to, time); }
    public static LTDescr LeanMove(this Transform transform, Vector3[] to, float time) { return LeanTween.move(transform.gameObject, to, time); }
    ...
    //LeanTween.moveLocal
    public static LTDescr LeanMoveLocal(this UnityEngine.GameObject gameObject, Vector3 to, float time) { return LeanTween.moveLocal(gameObject, to, time); }
    public static LTDescr LeanMoveLocal(this UnityEngine.GameObject gameObject, LTBezierPath to, float time) { return LeanTween.moveLocal(gameObject, to, time); }
    public static LTDescr LeanMoveLocal(this UnityEngine.GameObject gameObject, LTSpline to, float time) { return LeanTween.moveLocal(gameObject, to, time); }
    ...
    //LeanTween.moveLocal
    public static LTDescr LeanMoveLocalX(this UnityEngine.GameObject gameObject, float to, float time) { return LeanTween.moveLocalX(gameObject, to, time); }
    public static LTDescr LeanMoveLocalY(this UnityEngine.GameObject gameObject, float to, float time) { return LeanTween.moveLocalY(gameObject, to, time); }
    public static LTDescr LeanMoveLocalZ(this UnityEngine.GameObject gameObject, float to, float time) { return LeanTween.moveLocalZ(gameObject, to, time); }
    ...
    public static LTDescr LeanMoveSpline(this UnityEngine.GameObject gameObject, Vector3[] to, float time) { return LeanTween.moveSpline(gameObject, to, time); }
    public static LTDescr LeanMoveSpline(this UnityEngine.GameObject gameObject, LTSpline to, float time) { return LeanTween.moveSpline(gameObject, to, time); }
    ...
    public static LTDescr LeanMoveSplineLocal(this UnityEngine.GameObject gameObject, Vector3[] to, float time) { return LeanTween.moveSplineLocal(gameObject, to, time); }
    ...
    //LeanTween.moveX
    public static LTDescr LeanMoveX(this UnityEngine.GameObject gameObject, float to, float time) { return LeanTween.moveX(gameObject, to, time); }
    ...
    //LeanTween.moveY
    public static LTDescr LeanMoveY(this UnityEngine.GameObject gameObject, float to, float time) { return LeanTween.moveY(gameObject, to, time); }
    ...
    //LeanTween.moveZ
    public static LTDescr LeanMoveZ(this UnityEngine.GameObject gameObject, float to, float time) { return LeanTween.moveZ(gameObject, to, time); }
    ...
    //LeanTween.pause
    public static void LeanPause(this UnityEngine.GameObject gameObject) { LeanTween.pause(gameObject); }
    //LeanTween.play
    ...
    //LeanTween.resume
    public static void LeanResume(this UnityEngine.GameObject gameObject) { LeanTween.resume(gameObject); }
    //LeanTween.resumeAll
    //LeanTween.rotate 
    public static LTDescr LeanRotate(this UnityEngine.GameObject gameObject, Vector3 to, float time) { return LeanTween.rotate(gameObject, to, time); }
    ...
    public static LTDescr LeanRotateAround(this UnityEngine.GameObject gameObject, Vector3 axis, float add, float time) { return LeanTween.rotateAround(gameObject, axis, add, time); }
    ...
    public static LTDescr LeanRotateAroundLocal(this UnityEngine.GameObject gameObject, Vector3 axis, float add, float time) { return LeanTween.rotateAroundLocal(gameObject, axis, add, time); }
    ...
    //LeanTween.rotateX
    public static LTDescr LeanRotateX(this UnityEngine.GameObject gameObject, float to, float time) { return LeanTween.rotateX(gameObject, to, time); }
    ...
    //LeanTween.rotateY
    public static LTDescr LeanRotateY(this UnityEngine.GameObject gameObject, float to, float time) { return LeanTween.rotateY(gameObject, to, time); }
    ...
    //LeanTween.rotateZ
    public static LTDescr LeanRotateZ(this UnityEngine.GameObject gameObject, float to, float time) { return LeanTween.rotateZ(gameObject, to, time); }
    ...
    //LeanTween.scale
    public static LTDescr LeanScale(this UnityEngine.GameObject gameObject, Vector3 to, float time) { return LeanTween.scale(gameObject, to, time); }
    ...
    //LeanTween.scaleX
    public static LTDescr LeanScaleX(this UnityEngine.GameObject gameObject, float to, float time) { return LeanTween.scaleX(gameObject, to, time); }
    ...
    //LeanTween.scaleY
    public static LTDescr LeanScaleY(this UnityEngine.GameObject gameObject, float to, float time) { return LeanTween.scaleY(gameObject, to, time); }
    ...
    //LeanTween.scaleZ
    public static LTDescr LeanScaleZ(this UnityEngine.GameObject gameObject, float to, float time) { return LeanTween.scaleZ(gameObject, to, time); }
    ...
    public static LTDescr LeanValue(this UnityEngine.GameObject gameObject, Color from, Color to, float time) { return LeanTween.value(gameObject, from, to, time); }
    //LeanTween.value (Color)
    //LeanTween.value (float)
    public static LTDescr LeanValue(this UnityEngine.GameObject gameObject, float from, float to, float time) { return LeanTween.value(gameObject, from, to, time); }
    public static LTDescr LeanValue(this UnityEngine.GameObject gameObject, Vector2 from, Vector2 to, float time) { return LeanTween.value(gameObject, from, to, time); }
    public static LTDescr LeanValue(this UnityEngine.GameObject gameObject, Vector3 from, Vector3 to, float time) { return LeanTween.value(gameObject, from, to, time); }
    //LeanTween.value (float)
    public static LTDescr LeanValue(this UnityEngine.GameObject gameObject, Action<float> callOnUpdate, float from, float to, float time) { return LeanTween.value(gameObject, callOnUpdate, from, to, time); }
    public static LTDescr LeanValue(this UnityEngine.GameObject gameObject, Action<float, float> callOnUpdate, float from, float to, float time) { return LeanTween.value(gameObject, callOnUpdate, from, to, time); }
    public static LTDescr LeanValue(this UnityEngine.GameObject gameObject, Action<float, object> callOnUpdate, float from, float to, float time) { return LeanTween.value(gameObject, callOnUpdate, from, to, time); }
    public static LTDescr LeanValue(this UnityEngine.GameObject gameObject, Action<Color> callOnUpdate, Color from, Color to, float time) { return LeanTween.value(gameObject, callOnUpdate, from, to, time); }
    public static LTDescr LeanValue(this UnityEngine.GameObject gameObject, Action<Vector2> callOnUpdate, Vector2 from, Vector2 to, float time) { return LeanTween.value(gameObject, callOnUpdate, from, to, time); }
    public static LTDescr LeanValue(this UnityEngine.GameObject gameObject, Action<Vector3> callOnUpdate, Vector3 from, Vector3 to, float time) { return LeanTween.value(gameObject, callOnUpdate, from, to, time); }
